...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url(); ?>assets_frontend/img/favicon.png" rel="icon">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#<?php echo base_url('page/layanan'); ?>e">Layanan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('page/kontak'); ?>">Kontak</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('page/blog'); ?>">Blog</a>
          </li>
        </ul>
      </div>
    </div>
